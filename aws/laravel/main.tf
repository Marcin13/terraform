...
module "aws_resource_simple_app" {
  ...
  lambda_layer_console_arn                       = "arn:aws:lambda:eu-central-1:209497400698:layer:console:23"
  lambda_layer_php_arn                           = "arn:aws:lambda:eu-central-1:209497400698:layer:php-80:25"
  lambda_layer_php_fpm_arn                       = "arn:aws:lambda:eu-central-1:209497400698:layer:php-80-fpm:23"
